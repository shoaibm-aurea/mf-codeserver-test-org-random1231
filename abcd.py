...
def create_commit(tree_sha, parent_branch_sha):
...
if __name__ == '__main__':
    ...
    parent_branch_sha = get_default_branch_head()
    commit_sha = create_commit(tree_sha, parent_branch_sha)
